            ...
            <table className="table table-striped">
              ...
              {data && data.length>0 && data.map((value, index) => (
                <tr>
                  ...
                  <Link onClick={() =>{GetEditdata(value._id,value.scope_id,value.name)}}><i className="mdi mdi-pencil-box"></i></Link>
                  </span>
                  </td>
                </tr>
                 ))
              ...
              <tr><td className="centre" colSpan={4}>No Data Found!</td></tr>
              }
              </tbody>
            </table>
          </div>
