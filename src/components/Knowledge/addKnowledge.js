          ...
          <div className="row">
            ...
            <div className="col-md-6">
                <div className="form-group row">
                  ...
                  <div className="col-sm-9">
                    <select name="co2_unit" onChange={(e) => {onchange(e)}} className="form-control">
              ...
              <div className="col-md-6">
                <div className="form-group row">
                  ...
                  <div className="col-sm-9">
                    <select name="ch4_unit" onChange={(e) => {onchange(e)}} className="form-control">
              ...
              <div className="col-md-6">
                <div className="form-group row">
                  <label className="col-sm-3 col-form-label">N<small>2</small>O Factor</label>
                  <div className="col-sm-9">
            ...
            <div className="col-md-6">
                <div className="form-group row">
                  <label className="col-sm-3 col-form-label">N<small>2</small>O Unit</label>
                  <div className="col-sm-9">
                    <select name="n2o_unit" onChange={(e) => {onchange(e)}} className="form-control">
