...
export const getCategoryDataAPI = async(id) => {
  ...
  if(userData)
  {
    try{
      ...
      // axios.defaults.headers.common['Accept'] = 'application/json';
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}/admin/get-category/${id}`,
      );
      // console.log("LoginAPI response", response);
      if (response.status === 200) {
...
export const getSubCategoryDataAPI = async(id) => {
  ...
  if(userData)
  {
    try{
      ...
      // axios.defaults.headers.common['Accept'] = 'application/json';
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}/admin/get-subcategory/${id}`,
      );
      // console.log("LoginAPI response", response);
      if (response.status === 200) {
...
export const getAddKnowledgeDataAPI = async(id) => {
  ...
  if(userData)
  {
    try{
      ...
      // axios.defaults.headers.common['Accept'] = 'application/json';
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}/admin/get-add-knowledge`,
      );
      // console.log("LoginAPI response", response);
      if (response.status === 200) {
...
export const getKnowledgeAPI = async(pagenumber) => {
  ...
  if(userData)
  {
    try{
      ...
      // axios.defaults.headers.common['Accept'] = 'application/json';
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}/admin/get-knowledge?page=${pagenumber}`
      );
      // console.log("LoginAPI response", response);
      if (response.status === 200) {
...
export const getSingleKnowledgeAPI = async(id) => {
  ...
  if(userData)
  {
    try{
      ...
      // axios.defaults.headers.common['Accept'] = 'application/json';
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}/admin/get-single-knowledge/${id}`,
      );
      // console.log("LoginAPI response", response);
      if (response.status === 200) {
...
export const UpdateKnowledgeAPI = async(data,id) => {
  ...
  if(userData)
  {
    try{
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}/admin/update-knowledge/${id}`,
        data,
        {headers:{"Content-Type":"application/json"}}
      );
      // console.log("LoginAPI response", response);
...
export const CreateKnowledgeAPI = async(data) => {
  ...
  try{
    ...
    const response = await axios.post(
      `${process.env.REACT_APP_API_URL}/admin/add-knowledge`,
      data,
      {headers:{"Content-Type":"application/json"}}
    );
    // console.log("LoginAPI response", response);
