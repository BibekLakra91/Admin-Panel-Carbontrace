  ...
  if(userData)
  {
    try{
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}/admin/update-category/${id}`,
        data,
...
export const CreateCategoryAPI = async(data) => {
  ...
  try{
    ...
    const response = await axios.post(
      `${process.env.REACT_APP_API_URL}/admin/add-category`,
      data,
      {headers:{"Content-Type":"application/json"}}
    );
    // console.log("LoginAPI response", response);
...
export const CreateSubCategoryAPI = async(data) => {
  ...
  try{
    ...
    const response = await axios.post(
      `${process.env.REACT_APP_API_URL}/admin/add-subcategory`,
      data,
      {headers:{"Content-Type":"application/json"}}
    );
    // console.log("LoginAPI response", response);
  ...
  if(userData)
  {
    try{
      ...
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}/admin/get-category?page=${pagenumber}`
      );
      // console.log("LoginAPI response", response);
      if (response.status === 200) {
...
export const getSubCategoryAPI = async(pagenumber) => {
  ...
  if(userData)
  {
    try{
      ...
      // axios.defaults.headers.common['Accept'] = 'application/json';
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}/admin/get-subcategory?page=${pagenumber}`
      );
      // console.log("LoginAPI response", response);
      if (response.status === 200) {
